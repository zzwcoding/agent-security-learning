...
| 17 | 精读 chapter4/execution-tools 分层架构——对照三层护栏+容器,列出缺的层及归属路线 | ✅ 已完成(平行窗口复刻,2026-08-29;对照分析见 `执行工具复刻/对照分析.md`) |
| 18 | 精读 NeMo Guardrails 五种 rail + 最小实践(quickstart + 语料 01 打 self-check rail,对照 llm-guard)——对照缺口清单 | 平行窗口进行中(交接说明 `handoff-nemo-rails.md`) |
