...
走完图纸路线 1–3 全部 + 路线 4 红队部分（推理端与端云隐私降为"熟悉即可"），交付物沉淀在本目录 `deliverables/`，能用 目标场景的语言讲清每个设计决策。
...
- 路线 4 红队部分在起步 Agent 上的落地化方案（按滚动排期,路线 3 已收官、按其缺口清单与 CI 回归种子开票;种子含:毒样本描述、中文短语盲区、叙事毒 0.02、拆行投毒、D4 误拒幻觉代偿等)
- 路线 4 熟悉档(端云隐私+推理端)与收尾三件(熟悉即可检验形式/汇报材料整合/零信任架构蓝图)
