# SOC 数字员工（soc-demo）· 项目设计文档合集

> 本文件由以下原文按顺序合并而成（未改写内容，仅加分隔标题）：
> 1. README.md　2. CONTEXT.md（术语表）　3. AGENTS.md　4. specs/modules.md（模块划分与接口卡）　5. docs/adr/0001-c5-reuse.md（架构决策）　6. PRD v1.1（product-handbook.md）


---

<!-- 来源文件：soc-demo/README.md -->
...
<!-- 来源文件：soc-demo/specs/modules.md -->
...
<!-- 来源文件：soc-demo/docs/adr/0001-c5-reuse.md -->
...
<!-- 来源文件：deliverables/route5/product-handbook.md -->
